!(function r(o, a, u) {
...
})(
  {
    1: [
          ...
          !(function(e) {
            ...
            (document.cookie = [
              ...
              'domain=' +
                (function() {
                  for (
                    var e = 'weird_get_top_level_domain=cookie',
          ...
          for (
            var t = (function(e) {
              if (e) {
                if (!e.expiry) {
                  e.expiry = new Date(
                    new Date().getTime() + 864e7,
                  ).toUTCString();
                }
                return (
                  i(encodeURIComponent(JSON.stringify(e)), e.expiry),
                  'expires=' + e.expiry
                );
              }
            })(e);
              ...
              try {
                ...
                if (t)
                  try {
                    ...
                    document.cookie =
                      r + '=;expires=Thu, 01 Jan 1970 00:00:01 GMT;path=/;' + s;
                  } catch (e) {}
              }
            })(n);
                    ...
                    success: function(e) {
                      var t = (function(e, t) {
                        ...
                        for (
                          ...
                          'number' == typeof e.groups[r].ratio &&
                            ((n += e.groups[r].ratio),
                            ++i,
                            s.push(e.groups[r]));
                        if (0 === i) return null;
                      ...
                      return i && i.testId === t.testId
                        ? ((i.session = f()),
                          (i.sessionStart = +new Date()),
                          u(i))
                        : u(t);
                    },
                    error: function() {
      ...
      { './constants.js': 2, './xhr.js': 8 },
    ],
    2: [
      function(e, t, n) {
        'use strict';
        Object.defineProperty(n, '__esModule', { value: !0 });
        (n.EMPTY_WIDGET_ID = '000000000000000000000000'),
          (n.LAZY_LOADED_WIDGETS = [
              ...
              ? ((function(e) {
                  var t = e.businessunitId,
                    ...
                    r =
                      ...
                      ('/data/jsonld/business-unit/' + t + '/location/' + n) +
                      '?' +
                      [
              ...
              : !(!e.name || !e.sku) &&
                ((function(e) {
                  var t = e.businessunitId,
                    ...
                    c =
                      'https://widget.trustpilot.com' +
                      ('5763bccae0a06d08e809ecbb' === i
                        ? '/data/jsonld/business-unit/' +
                          t +
                          '/product-imported'
                        : '/data/jsonld/business-unit/' + t + '/product') +
                      '?sku=' +
    ...
    4: [
          ...
          (i(f, [
            {
              ...
              value: function() {
                var n = this;
                this.hasABTestElements()
                  ? (0, a.getABSettingsAsync)(this.businessUnitId, function(
                      e,
                      t,
                    ) {
                      (n.abSettings = e),
                        (n.sessionExpiry = t),
                        n.findAndApplyWidgets();
                    })
            ...
            },
            {
              ...
              value: function(n, e) {
                var i = this;
                (n.firstChild && 'IFRAME' === n.firstChild.tagName && !e) ||
                  ('group' in n.dataset
                    ? (0, a.getABSettingsAsync)(
                        n.dataset.businessunitId,
                        function(e, t) {
                          (i.abSettings = e),
                            (i.sessionExpiry = t),
                            i.createWidget(n);
            ...
            },
            {
              ...
              value: function() {
                ...
                e &&
                  0 !== e.length &&
                  ((this.stats.normalElements = e.filter(function(e) {
                    return !('group' in e.dataset);
                  }).length),
                  (this.stats.abTestElements = e.filter(function(e) {
                    return 'group' in e.dataset;
                  }).length),
            ...
            },
            {
              ...
              value: function(e) {
                if (
                  (this.removeWidget(e),
                  this.checkWidgetDisplayAndUpdateDataset(e))
                ) {
                  var t = e.dataset;
                  (0, o.default)(t);
                  var n = 'group' in t && this.abSettings,
                    i = n
                      ? {
                          container: e,
                          dataset: t,
                      ...
                      : { container: e, dataset: t },
                    s = new u.default(i);
                  return (
                    s.initialize(),
                    (this.stats.applied += 1),
                    (this.stats[n ? 'abTestApplied' : 'normalApplied'] += 1),
            ...
            },
            {
              ...
              value: function(e) {
                var t = e.dataset;
                return (
                  !(this.abSettings && 'group' in t) ||
                  l(this.abSettings.group) === l(t.group) ||
                  (l(this.abSettings.group) === r.OFF &&
                    ((t.templateId = r.EMPTY_WIDGET_ID),
                    (t.styleHeight = '0'),
                    (t.group = r.OFF),
                    !0))
                );
      ...
      { './ab-settings': 1, './constants': 2, './snippets': 3, './widget': 6 },
    ],
    5: [
      function(e, t, n) {
        'use strict';
        ...
        var o =
          ((function(e, t, n) {
              ...
              value: function(e, t) {
                (this._iframe = (function(e) {
                  ...
                  return (
                    ...
                    (t.style.overflow = e.overflow),
                    (t.frameBorder = e.frameBorder),
                    (t.scrolling = e.scrolling),
                    (t.allowTransparency = e.allowTransparency),
                    (t.title = 'Customer reviews powered by Trustpilot'),
                    (t.loading = e.loading || 'auto'),
                    (t.src = e.src),
                    t
                  );
                })(this.getIframeOptionsFromData())),
            ...
            },
            {
              ...
              value: function(e) {
                var t = this._iframe.getBoundingClientRect(),
                  n = t.width || this._iframe.offsetWidth,
            ...
            },
            {
              ...
              get: function() {
                return {
                  height: r(this.dataset.styleHeight),
                  width: r(this.dataset.styleWidth),
                };
              },
            },
            {
              ...
              get: function() {
                ...
                function e(e) {
                  return Object.keys(n.dataset)
                    .filter(e)
                    .map(t);
                }
                var n = this,
                  i = ['businessunitId', 'templateId'];
                '539adbd6dec7e10e686debff' === this.dataset.templateId &&
                  (i = [].concat(
                    (function(e) {
                      if (Array.isArray(e)) {
        ...
        function a(e, t, n) {
          !(function(e, t) {
            ...
            (this.name = e),
            (this.dataset = t),
            (this.iframeData = n || this.defaultIframeOptions);
        }
        n.default = o;
      },
      {},
    ...
    6: [
      function(e, t, n) {
          ...
          i(c, [
            {
              ...
              value: function(e) {
                var t = 0 < arguments.length && void 0 !== e ? e : 200,
                  ...
                  s = n.height || this.container.offsetHeight;
                return (
                  0 <= n.top &&
                  0 <= n.left &&
                  n.bottom - s - t <=
            ...
            },
            {
              ...
              value: function(e, t) {
                var n = this,
                  i = 1 < arguments.length && void 0 !== t ? t : function() {};
                ...
                var s = e.name,
                  ...
                  u = {
                    ...
                    ping: function() {
                      n.iframes.main.sendMessage({ command: 'pong' }),
                        (n.stats.pongSent = !0);
                    },
                    'resize-height': function() {
                      return n.getIframeOrMain(s).resizeHeight(o);
                    },
                    impression: function() {
            ...
            },
            {
              ...
              value: function(e, t) {
                var n = this,
                  i = new r.default(e, this.dataset, t);
                (this.iframes[e] = i),
                  (this.stats.createIFrameCalls += 1),
                  i.initialize(this.container, function() {
        ...
        function c(e) {
          ...
          Object.keys(u).forEach(function(e) {
            ...
            (this.isLazyLoaded =
              -1 < l.LAZY_LOADED_WIDGETS.indexOf(i.templateId)),
            (this.stats = {
              createIFrameCalls: 0,
              iframeLoadEvents: 0,
              events: {},
      ...
      { './../constants': 2, './iframe': 5, './tracking': 7 },
    ],
    7: [
      function(e, t, n) {
        'use strict';
              ...
              value: function(e) {
                ...
                return (
                  this.session &&
                    ...
                    (t.sessionExpiry = this.sessionExpiry)),
                  this.anonymousId && (t.anonymousId = this.anonymousId),
                  this.testId && (t.testId = this.testId),
                  t
                );
              },
            },
            ...
            },
            {
              ...
              value: function() {
                var t,
                  ...
                  r =
                    ((t = function() {
                      (e.templateId !== d.EMPTY_WIDGET_ID &&
                        !e.shouldDetachListener()) ||
                        (window.removeEventListener('scroll', a, o),
                        window.removeEventListener('resize', u, o));
                    }),
                    (n = 100),
                    (i = void 0),
                    function() {
                  ...
                  a = window.addEventListener('scroll', r, o),
                  u = window.addEventListener('resize', r, o);
                r();
              },
            },
            {
    ...
    9: [
      function(t, e, n) {
        ...
        !(function(n) {
          try {
            (e = t('./lib/widget-management.js').default),
              ...
              window.Trustpilot.Modules.WidgetManagement
                ? window.Trustpilot.Modules.WidgetManagement.version !== n &&
                  console.log(
                ...
                : ((window.Trustpilot.Modules.WidgetManagement = new e(
                    window,
                    document,
                    n,
                  )),
            ...
            !(function() {
              function e(e) {
                ...
                document.createElement('img').src =
                  'https://widget.trustpilot.com/feedback/report-error?' + t;
              }
              try {
